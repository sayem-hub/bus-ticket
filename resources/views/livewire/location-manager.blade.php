...
@if ($mode === 'create' || $mode === 'edit')
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-3">
                    <div>
                        <label for="location.location_name"" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Location Name</label>
                        <input type="text" wire:model="location.location_name" id="location.location_name"" autocomplete="given-name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Location Name">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="flex space-x-2">
                            <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" wire:click="edit({{ $locationName->id }})">Edit</button>
                            <button type="button" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" wire:click="delete({{ $locationName->id }})">Del</button>
